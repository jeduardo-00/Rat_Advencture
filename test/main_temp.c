...
int main()
{
    ...
    ALLEGRO_FONT* font_2 = al_load_font("C:\\Project_gamer\\assets\\fontes\\font.ttf", 50, 0);
    must_init(font_2, "font");

    ALLEGRO_FONT* font_3 = al_load_font("C:\\Project_gamer\\assets\\fontes\\font.ttf", 30, 0);
    ...
    while(1)
    {
        ...
        if(redraw && al_is_event_queue_empty(queue))
        {
            if (estado_jogo == JOGANDO)
            {
                ...
                al_draw_textf(font,al_map_rgb(255, 255, 255), 0, barra_tempo.y, 0, "TEMPO");
            ...
            else if (estado_jogo == GAME_OVER)
            {
                ...
                al_draw_textf(font_2, al_map_rgb(255, 255, 255), 280, 50, 0,"GAME OVER");
                al_draw_textf(font_3, al_map_rgb(255, 255, 255), 230, 260, 0,"Aperte ENTER para reiniciar");
                al_draw_textf(font, al_map_rgb(255, 255, 255), 335, 295, 0,"SCORE: %d", score);
            }
